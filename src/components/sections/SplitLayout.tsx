...
function CopyEmailButton() {
  ...
  return (
    <motion.button
      ...
      className="inline-flex items-center gap-2 h-9 px-4 text-xs font-medium bg-white/50 text-foreground/70 shadow-subtle rounded-[13px] hover:bg-white hover:text-foreground hover:shadow-card transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-foreground/20 focus:ring-offset-2 focus:ring-offset-background"
            ...
            >
              ...
              >
                <motion.a
                  ...
                  className="group relative inline-flex items-center gap-2 h-9 pl-1 pr-4 text-xs font-medium bg-[#0f172a] text-white shadow-subtle rounded-[13px] hover:shadow-card focus:outline-none focus:ring-2 focus:ring-foreground/20 focus:ring-offset-2 focus:ring-offset-background transition-all duration-200"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  transition={{ type: 'spring', stiffness: 400, damping: 17 }}
                >
